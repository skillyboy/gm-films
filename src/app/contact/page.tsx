          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-6 font-montserrat">
                Contact <span className="accent-gradient">Information</span>
              </h2>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-6">
                  <a href="#" className="bg-gray-800 p-3 text-gray-300 rounded-md hover:text-accent hover:-translate-y-0.5 transition-all duration-300">
